(function () {
    ...
    function renderPageHeader() {
        const placeholder = document.getElementById('layout-page-header');
                  ...
                  <ul class="navbar-nav">
                    ...
                    <li class="nav-item dropdown">
                      ...
                      >
                        ...
                        ></span>
                        <span class="nav-link-title"> شرکت کنندگان </span>
                      </a>
                      <div class="dropdown-menu">
                        <a class="dropdown-item" href="./form-elements.html"> لیست شرکت کنندگان </a>
                        <a class="dropdown-item" href="/Participant/create.html">
                          افزودن شرکت کننده
          ...
          <div class="navbar-nav flex-row order-md-last">
            <div class="nav-item dropdown">
              <a href="#" class="nav-link d-flex lh-1 text-reset p-0" data-bs-toggle="dropdown">
                <span class="avatar avatar-sm">م</span>
                <div class="d-none d-xl-block pe-2">
                  <div>مدیر سیستم</div>
                  <div class="mt-1 small text-secondary">ادمین</div>
                </div>
              </a>
            ...
            <div>
              <form action="./" method="get" autocomplete="off" novalidate>
                <div class="input-icon">
                  ...
                  <input type="text" value="" class="form-control" placeholder="جستجو..." aria-label="Search">
                </div>
              </form>
            </div>
          </div>
      ...
      <div class="toast-container position-fixed bottom-0 start-0 p-3" style="z-index: 1080">
        <div id="app-toast" class="toast" role="alert" aria-live="assertive" aria-atomic="true">
          <div class="toast-header">
            <strong class="me-auto" id="app-toast-title">پیام سیستم</strong>
    ...
    window.showToast = function (message, title = 'پیام سیستم') {
